      ...
      <div style={{ 
        ...
        <div style={{ display: "flex", gap: "12px", fontSize: "11px", fontWeight: "600", color: "#64748b" }}>
          <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            <span style={{ width: "10px", height: "10px", backgroundColor: "#22c55e", borderRadius: "2px", display: "inline-block" }}></span> 
            Visit Day
          </span>
          <span style={{ display: "flex", alignItems: "center", gap: "4px" }}>
            <span style={{ width: "10px", height: "10px", backgroundColor: "#fff", border: "2px solid #2563eb", borderRadius: "2px", display: "inline-block" }}></span> 
            Today
          </span>
        </div>
      </div>
...
if (isToday) {
  cellStyle = { 
    ...cellStyle, 
    border: "2px solid #2563eb",   // force blue border on top
    boxShadow: "0 0 0 1px #2563eb" // optional extra strength
  };
}
  return (
